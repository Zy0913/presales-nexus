    ...
    <header className="h-12 bg-white border-b border-zinc-200 flex items-center justify-between px-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-zinc-900 text-sm hidden sm:block">PreSales Nexus</span>
        </div>
        ...
        {/* Project Selector */}
        {currentProject && (
          <button className="flex items-center gap-1.5 px-2 py-1 rounded-md hover:bg-zinc-100 transition-colors">
