...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    priority: 'high',
    title: '任务被阻塞',
    content: '陈雨婷 将任务《编写投标技术方案》标记为受阻',
    isRead: false,
    createdAt: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(), // 3小时前
    senderId: 'user_004',
    senderName: '陈雨婷',
    senderAvatar: '/avatars/chen.jpg',
    projectId: 'proj_001',
    projectName: '深圳湾口岸智慧通关系统',
    taskId: 'task_006',
    targetType: 'task_board',
  ...
  },
  {
    ...
    priority: 'normal',
    title: '审批通过',
    content: '您的文档《API 接口设计文档》已通过审核',
    isRead: true,
    createdAt: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(), // 1天前
    senderId: 'user_001',
    senderName: '张明远',
    senderAvatar: '/avatars/zhang.jpg',
    projectId: 'proj_001',
    projectName: '深圳湾口岸智慧通关系统',
    documentId: 'doc_004',
  ...
  },
  {
    ...
    priority: 'urgent',
    title: '项目截止提醒',
    content: '深圳湾口岸智慧通关系统投标截止日期临近（剩余2天）',
    isRead: false,
